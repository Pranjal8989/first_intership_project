...
.bg-img {
  /* The image used */
  background-image: url(<?php echo base_url('assets/image/nature.jpg');?>);
...
<form method='POST' action='<?php echo base_url('Welcome/signin/'); ?>'>
  ...
  <button type="submit" class="btn btn-primary">Signin<i class="fa fa-sign-in" style="font-size:20px;color:white"></i></button>
  <a class="btn btn-primary" href="<?php echo base_url('Welcome/login_form/');?>" class="link-light">Signup <i class="fa fa-user-plus	
