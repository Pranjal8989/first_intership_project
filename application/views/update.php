...
<div id="page-wrapper">
    <div class="forms">
        ...
        <div class="form-grids row widget-shadow" data-example-id="basic-forms">
            ...
            <form action="<?php echo base_url().'Student/updatedata/'.$data->id; ?>" method="POST">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-5"> 
                                        ...
                                        <input type="text" class="form-control" id="mobile1" placeholder="Mobile Number" name="mobile2" onblur="check_mobile()" value=" <?php echo $data->mobile2; ?>" required> 
                                    </div>
									<div class="row">
                                    <div class="form-group col-md-5">
